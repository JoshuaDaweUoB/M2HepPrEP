...
m2hepprep_baseline_vars <- m2hepprep_raw %>%
  ...
  select(
    ...
    srb_1m_m, dem_edu, nms_emp, nms_inc, nms_inc_cad, nms_inc_usd, srb_1m_fc_hiv,
    ...
    odu_6m, dem_hltins, sdu_srg, sub_frq1m, srb_3m_sxp, srb_1m_m_hiv, srb_1m_f_hiv, srb_1m_f_drg_cc, srb_1m_f_drg_hro, srb_1m_f_drg_main, srb_1m_f_drg_aph, srb_1m_f_drg_psy, 
    ...
    sdu_wrk, sdu_wrk_6m_frq, srb_3m,, srb_3m_sxp, idu_6mplc2___3, dem_gender_id, dem_gender,
    srb_3m_prst, srb_prst04, srb_3m, srb_3m_f, srb_1m_fc_pv, srb_1m_fc_pa, srb_1m_fc_npv, srb_1m_fc_npa, srb_1m_fc_cv, srb_1m_fc_ca, srb_1m_fc_mcv, srb_1m_fc_mco, srb_1m_fc_mca
  )
...
cols_to_na <- c(
  ...
  "srb_1m_fc_ca", "srb_1m_fc_mcv", "srb_1m_fc_mco", "srb_1m_fc_mca", "cla_16a"
)
